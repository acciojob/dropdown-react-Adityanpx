...
function App() {
  ...
  const currentCity = states[selectedStateIndex].city;
  const currentLandmark = currentCity[selectedCityIndex].landmarks;
  ...
  return (
    <div id="main">
      <div class="container">
        ...
        <div id="card">
          <div id="state-name">
            <h3>{states[selectedStateIndex].name}</h3>
          </div>
          <div id="state-description">
            <p>{states[selectedStateIndex].description}</p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
		...
		<div id="card">
        <h4>{currentCity[selectedCityIndex].name}</h4>
        <div id="city-description">
          {currentCity[selectedCityIndex].description}
        </div>
		</div>
      </div>
      <div class="container">
        ...
        <select
          ...
          onChange={(e) => setSelectedLandMark(parseInt(e.target.value))}
        >
          {currentLandmark.map((landmark, index) => (
            <option key={index} value={index}>
              {landmark.name}
            </option>
          ))}
		...
		<div id="card">
        <h4>{currentLandmark[selectedLandmark].name}</h4>
        <div>{currentLandmark[selectedLandmark].description}</div>
      </div>
	  </div>
    </div>
  );
